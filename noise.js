...
/*
Code generated with Faust version 2.32.13
Compilation options: -lang wasm -es 1 -single -ftz 2
*/

function getJSONnoise() {
	return '{"name": "noise","filename": "noise.dsp","version": "2.32.13","compile_options": "-lang wasm -es 1 -single -ftz 2","include_pathnames": ["/usr/local/share/faust","/usr/local/share/faust","/usr/share/faust",".","/tmp/sessions/6E819E7D7DCBF63AEA37CCA9D6D625476FB701A8/web/wasmjs"],"size": 16,"inputs": 0,"outputs": 1,"meta": [ { "author": "Grame" },{ "compile_options": "-lang wasm -es 1 -single -ftz 2" },{ "copyright": "(c)GRAME 2009" },{ "filename": "noise.dsp" },{ "license": "BSD" },{ "name": "noise" },{ "version": "1.1" }],"ui": [ {"type": "vgroup","label": "noise","items": [ {"type": "vslider","label": "Volume","address": "/noise/Volume","index": 0,"meta": [{ "acc": "0 0 -10 0 10" },{ "style": "knob" }],"init": 0.5,"min": 0,"max": 1,"step": 0.1}]}]}';
}
/*
 faust2webaudio
...
// Usage : noise.createDSP(audioCtx, 1024).then(dsp => dsp.connect(audioCtx.destination));
